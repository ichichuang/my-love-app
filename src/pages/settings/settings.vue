      ...
      <view class="settings-panel">
        ...
        <view class="segmented-control">
          <button
            ...
            :class="{ 'segmented-control__button--active': theme.density === option.value }"
            hover-class="segmented-control__button--pressed"
      ...
      <view class="settings-panel">
        ...
        <view class="segmented-control">
          <button
            ...
            :key="option.value"
            class="segmented-control__button"
            :class="{ 'segmented-control__button--active': theme.fontScale === option.value }"
            hover-class="segmented-control__button--pressed"
...
.segmented-control__button--pressed {
